...
def test_load_location_notes_structure(sample_tsv_file):
    """Tests if location data is loaded from TSV with correct columns and rows."""
    ...
    expected_columns = ['LocationID', 'Description', 'DangerLevel']
